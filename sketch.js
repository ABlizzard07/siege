...
function setup() {
  ...
  ground2 = new Ground(1100,450,252,20);
  ...
  block17 = new Block(1100,415,36,50);
  block18 = new Block(1136,415,36,50);
  block19 = new Block(1172,415,36,50);
  block20 = new Block(1064,415,36,50);
  block21 = new Block(1028,415,36,50);
  block22 = new Block(1100,365,36,50);
  block23 = new Block(1136,365,36,50);
  block24 = new Block(1064,365,36,50);
  block25 = new Block(1100,315,36,50);

  shape = new Shape(250,450,50);

  chain = new Chain(shape.body,{x:150,y:400});
